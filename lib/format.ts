...
// Same as to12Hour but with an uppercase AM/PM, for prefilling editable
// text inputs (e.g. "10:50 AM" rather than "10:50 am").
export function to12HourUpper(t: string) {
  return to12Hour(t).replace(/am|pm/, (m) => m.toUpperCase());
}
